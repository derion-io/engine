...
exports.oracleWindow = exports.chainlinkDecimals = exports.isChainlink = exports.isUniv2 = exports.isUniv3 = exports.tryParseLog = exports.computePoolAddress = exports.sortsBefore = exports.mergeTwoUniqSortedLogs = exports.compareLog = exports.DIV = exports.WEI = exports.IEW = exports.round = exports.truncate = exports.BIG = exports.NUM = exports.STR = exports.kx = exports.rateFromHL = exports.rateToHL = exports.getTopics = exports.mergeDeep = exports.parseSqrtX96 = exports.parsePrice = exports.parseUq128x128 = exports.packId = exports.detectDecimalFromPrice = exports.add = exports.max = exports.div = exports.sub = exports.mul = exports.formatPercent = exports.formatFloat = exports.getNormalAddress = exports.isErc1155Address = exports.getErc1155Token = exports.formatMultiCallBignumber = exports.decodePowers = exports.numberToWei = exports.weiToNumber = exports.bn = exports.provider = void 0;
...
const rateToHL = (r, DURATION = constant_1.SECONDS_PER_DAY) => {
    if (r == 0) {
        return 0;
    }
...
const rateFromHL = (HL, DURATION = constant_1.SECONDS_PER_DAY) => {
    if (HL == 0) {
        return 0;
    }
...
function isUniv3(pool) {
    return pool?.FETCHER === constant_1.ZERO_ADDRESS && !isChainlink(pool);
}
exports.isUniv3 = isUniv3;
function isUniv2(pool) {
    return !isChainlink(pool) && pool?.FETCHER !== constant_1.ZERO_ADDRESS;
}
exports.isUniv2 = isUniv2;
function isChainlink(pool) {
    return chainlinkDecimals(pool?.ORACLE) > 0;
}
exports.isChainlink = isChainlink;
function chainlinkDecimals(ORACLE) {
    return parseInt(ORACLE.substring(18, 26), 16);
}
exports.chainlinkDecimals = chainlinkDecimals;
function oracleWindow(ORACLE) {
    return parseInt(ORACLE.substring(10, 18), 16);
}
exports.oracleWindow = oracleWindow;
